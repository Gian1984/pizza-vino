          ...
          <div class="lg:py-24">
            ...
            <div class="mt-5 sm:mt-12">
              <blockquote class="sm:flex lg:block">
                ...
                <div class="mt-2 sm:mt-0 sm:ml-6 lg:mt-5 lg:ml-0">
                  <h1 class="text-6xl text-white" id="rinunciare" lang="it">
                    A tre cose non si può assolutamente rinunciare:
                  </h1>
                  <cite class="text-4xl mt-2 block font-extralight text-white italic" id="header_text1" lang="it">
                    1 &mdash; Un ottima pizza.
                  </cite>
                  <cite class="text-4xl mt-2 block font-extralight text-white italic" id="header_text2" lang="it">
                    2 &mdash; Un buon bicchiere di vino.
                  </cite>
                  <cite class="text-4xl mt-2 block font-extralight text-white italic" id="header_text3" lang="it">
                    3 &mdash;
                  </cite>
                </div>
              </blockquote>
            ...
            <div class="mt-10 sm:mt-12">
              <a href="doc/pizza-vino-it.pdf" class="mr-2 inline-flex items-center text-black bg-white rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:bg-gray-300">
                <span class="px-3 py-0.5 text-xs font-semibold leading-5 uppercase tracking-wide bg-gradient-to-r from-teal-500 to-cyan-600 rounded-full" lang="it">Scarica il menù</span>
